<?php
    ...
    $cssStyle=$cssStyleList['indexAdmin'];
                    ...
                    <td colspan="2" class="nav-bar" >
                        <form action="doctors.php" method="post" class="header-search">
                            ...
                            <?php
                                ...
                                echo ' </datalist>';
                            ?>
                            <input type="Submit" value="Recherche" class="login-btn btn-primary-soft btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
                        </form>
                    </td>
                    <td width="15%">
                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Rendez-vous à Venir Jusqu'au <?php
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                        Prochain
                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">Voici un accès rapide aux rendez-vous à venir jusqu'à 7 jours<br></p>
                                </td>
                                <td>
                                    <p style="text-align:left;padding:10px;padding-right:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Sessions à Venir Jusqu'à <?php
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                        Prochaine
                                    </p>
                                    <p style="padding-bottom:19px;text-align:left;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">Voici un accès rapide aux sessions à venir programmées jusqu'à 7 jours<br></p>
                                </td>
                            </tr>
                            <tr>
                                <td width="50%">
                                    <center>
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="table-headin" style="font-size: 12px;">Numéro du Rendez-vous</th>
                                                <th class="table-headin">Nom du Patient</th>
                                                <th class="table-headin">Médecin</th>
                                                <th class="table-headin">Séance</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                    ...
                                    <center>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="table-headin">Médecin</th>
                                                <th class="table-headin">Date et heure planifiées</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="appointment.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Afficher Tous les Rendez-vous</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="schedule.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Afficher Toutes les Séances</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
