            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor ">
                        <a href="doctors.php" class="non-style-link-menu "><div><p class="menu-text">Les Médecins</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">Réservations</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;text-align:left;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Voici un accès rapide aux sessions à venir programmées jusqu'à 7 jours<br>
                                    </p>
                                </td>
                            </tr>
                            <tr>
