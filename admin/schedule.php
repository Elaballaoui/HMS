<?php
    ...
    $pageTitle=$pageTitleList['Calendrier'];
                ...
                <tr>
                    <td colspan="4" >
                        <div style="display: flex;margin-top: 40px;">
                            ...
                            <a href="?action=add-session&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="margin-left:25px;background-image: url('../assets/img/icons/add.svg');">Ajouter une Séance</font></button></a>
                        </div>
                    </td>
                </tr>
                <tr>
                       ...
                       <center>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="table-headin">Max Num qui peut être réservé</th>
