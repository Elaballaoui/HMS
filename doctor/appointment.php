<?php
    ...
    $cssStyle=$cssStyleList['appointmentScheduleDoctor'];
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Mes réservations</p>
                    </td>
                    <td width="15%">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Mes réservations (<?php echo $list110->num_rows; ?>)</p>
                    </td>
                </tr>
                <tr>
                       ...
                       <center>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="table-headin">Séance Date & heure</th>
                                <th class="table-headin">Date de réservation</th>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <form action="add-session.php" method="POST" class="add-new-form">
                                    <label for="title" class="form-label">Titre de Séance :</label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label">Sélectionnez Médecin  :</label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <option value="" disabled selected hidden>Choisissez le Nom du Médecin dans la Liste</option><br/>';
                                        ...
                                        echo '</select><br><br>
                                            ...
                                            <tr>
                                                <td class="label-td" colspan="2">
                                                    <label for="nop" class="form-label">Nombre de patients/numéros de réservation :</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="label-td" colspan="2">
                                                    <input type="number" name="nop" class="input-text" min="0"  placeholder="Le numéro de réservation définitif pour cette séance dépend de ce numéro" required><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="label-td" colspan="2">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    ...
                                                    <input type="submit" value="Placer cette session" class="login-btn btn-primary btn" name="shedulesubmit">
                                                </td>
                                            </tr>
                                            </form>
                                            </tr>
